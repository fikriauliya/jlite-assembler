...
ocamlc -o program jlite_structs.cmo jlite_annotatedtyping.cmo jlite_assembler.cmo jlite_toir3.cmo jlite_lexer.cmo jlite_parser.cmo ir3_structs.cmo jlite_main.cmo
