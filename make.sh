...
ocamlc -c jlite_ir3converter.ml
ocamlc -c jlite_assembler.ml
ocamlc -c jlite_main.ml
ocamlc -o program jlite_structs.cmo jlite_annotatedtyping.cmo jlite_assembler.cmo jlite_ir3converter.cmo jlite_lexer.cmo jlite_parser.cmo ir3_structs.cmo jlite_main.cmo